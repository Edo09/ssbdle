...
const en = {
  ...
  leaderboard: {
    ...
    bestRun: 'Best run',
    fastest: 'Time',
    fastestGuide: 'Fastest daily solves — your best time to crack the daily fighter.',
    bestTime: 'Best time',
  },
  a11y: {
    correct: 'correct',
...
const es: typeof en = {
  ...
  leaderboard: {
    ...
    bestRun: 'Mejor ronda',
    fastest: 'Tiempo',
    fastestGuide: 'Resoluciones más rápidas del diario: tu mejor tiempo para adivinar al luchador.',
